...
int split_table_digit_count(uint64_t x) {
  // table[i] contains number of digits in pow(2, i)
  static uint8_t table1[64] = {
  ...
  // table[i] contains 1 less than the smallest power of 10 greater than pow(2, i).
